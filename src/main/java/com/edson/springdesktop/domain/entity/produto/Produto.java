...
public class Produto {
  ...
  @Size(
    min = 1,
    max = 255,
    message = "O código do produto deve ter entre 1 e 255 caracteres"
  )
  ...
  @Size(
    min = 1,
    max = 255,
    message = "A descrição deve ter entre 1 e 255 caracteres"
  )
  ...
  @Size(
    min = 1,
    max = 50,
    message = "A unidade deve ter entre 1 e 50 caracteres"
  )
